...
#
# Usage:
#   ./migrate_blogger.sh input.xml output_dir
...
BOOKS=(
  ...
  "desde cosquin rock" "el cine negro de los monos" "la mancha del quijote"
...
VOLUMES=("sangre de monos" "abortos de monos" "monopolis")
LOCATIONS=("cordoba" "rio ceballos" "villa allende")
